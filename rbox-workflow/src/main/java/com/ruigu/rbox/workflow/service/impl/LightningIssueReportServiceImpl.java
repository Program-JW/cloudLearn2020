...
public class LightningIssueReportServiceImpl implements LightningIssueReportService {
    ...
    public ServerResponse exportExcel(Integer queryType) throws Exception {
        ...
        String name = "闪电链每月汇总数据-" + year +"年"+ monthValue +"月-";
        ...
        WriteSheet writeSheet2 = EasyExcel.writerSheet(1, "分人").head(LightningIssueReportVO.class).build();
        ...
        String title = "闪电链每月汇总数据"+ year +"年"+ monthValue +"月";
        String content = "请见附件!";
